...
## [0.4.0](https://github.com/PatKeenan/label-loop/compare/v0.3.0...v0.4.0) (2026-09-16)
...
* **api:** per-key rate limiting, in Redis ([#40](https://github.com/PatKeenan/label-loop/issues/40)) ([1f76648](https://github.com/PatKeenan/label-loop/commit/1f7664811f2704d1673811fa909d7293c0943f72))
...
* **k6:** ramp and spike, against a fake with real latency ([#43](https://github.com/PatKeenan/label-loop/issues/43)) ([5c2f9ae](https://github.com/PatKeenan/label-loop/commit/5c2f9ae74ec31239b939b9feb1f4a86f8fbd4c55))
...
* **db:** the queue privilege probe no longer depends on today's partition ([#44](https://github.com/PatKeenan/label-loop/issues/44)) ([8cafa15](https://github.com/PatKeenan/label-loop/commit/8cafa15d88ddd3f248d6bc655f4c00358e19dc34))
...
* the breaking point, with real numbers ([#46](https://github.com/PatKeenan/label-loop/issues/46)) ([564afe9](https://github.com/PatKeenan/label-loop/commit/564afe9d572071ff361bed4a82c1bf6f4674d851))


### Build & Dependencies

* bump nginxinc/nginx-unprivileged from 1.29.3-alpine to 1.31.5-alpine in /apps/web ([#41](https://github.com/PatKeenan/label-loop/issues/41)) ([a79b217](https://github.com/PatKeenan/label-loop/commit/a79b217d73ea442a9219d1600ef9003b81614c8c))
